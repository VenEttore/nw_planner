                ...
                <div class="flex items-center gap-2 mb-1 relative group">
                  ...
                  {#if conflictBadgeFor(event)}
                    <div class="absolute -top-1 -right-1" role="presentation">
                      ...
                      <div class="pointer-events-none absolute right-0 mt-1 w-72 z-[1100] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded shadow-lg p-2 text-xs text-gray-700 dark:text-gray-300 hidden group-hover:block">
